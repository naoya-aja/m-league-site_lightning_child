...
?>
	...
	<span class="vcard author entry-meta_items entry-meta_items_author<?php echo $meta_hidden_author; ?>"><span class="fn">
		<a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>?post_type=news"><?php echo esc_html( $author ); ?></a>
	</span></span>
